Task mode: `draft_analysis_exploratory_v1`

Primary objective:

Read the cluster evidence and externalize broad intermediate reasoning before
any final label is chosen.

This is Draft A: exploratory. Its job is to notice plausible ecological
stories, including alternatives that may later be rejected by stricter review.
